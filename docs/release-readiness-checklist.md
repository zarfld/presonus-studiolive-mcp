...
- [ ] **Mute tool HIL-verified**: `prepare_mute_change_set` + `apply_change_set` tested on
  physical hardware; mute/unmute confirmed to work correctly.  
  _Status: ⬜ Not yet run_

- [ ] **Fader tool HIL-verified**: `prepare_fader_change_set` tested; fader movement confirmed.  
  _Status: ⬜ Not yet run — blocked on fader taper probe_

- [ ] **Write tool safety review**: All write tools reviewed for unintended side-effects.  
  _Status: ⬜ Pending_

### P2 — HIL tests

- [ ] **HIL tests pass on 32SC**: `pnpm test:hil` passes against physical StudioLive 32SC
  firmware 3.3.0.109659. Evidence linked.  
  _Status: ⬜ Not run in this planning cycle_
